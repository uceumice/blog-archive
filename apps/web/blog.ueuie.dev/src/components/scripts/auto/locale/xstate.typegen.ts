...
export interface Typegen0 {
  ...
  internalEvents: {
    '': { type: '' };
    'done.invoke.(machine).getting_locale_by_cf_headers:invocation[0]': {
      type: 'done.invoke.(machine).getting_locale_by_cf_headers:invocation[0]';
      data: unknown;
      __tip: 'See the XState TS docs to learn how to strongly type this.';
    };
    'error.platform.(machine).getting_locale_by_cf_headers:invocation[0]': {
      type: 'error.platform.(machine).getting_locale_by_cf_headers:invocation[0]';
      data: unknown;
    };
